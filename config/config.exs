...
config :learning, LearningWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: LearningWeb.ErrorHTML, json: LearningWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: Learning.PubSub,
  live_view: [signing_salt: "kreNaxdJ"]
...
config :learning, Learning.Mailer, adapter: Swoosh.Adapters.Local
